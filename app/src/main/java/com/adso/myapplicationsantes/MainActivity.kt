...
import com.adso.myapplications.Ingreso2
import com.adso.myapplicationsantes.databinding.Ingreso2Binding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cedulaOptions = resources.getStringArray(R.array.cedula_options)
        ...
        nextButton.setOnClickListener {
            ...
            if (nombres.isNotEmpty() && apellidos.isNotEmpty() && fechaNacimiento.isNotEmpty() && cedula.isNotEmpty() && email.isNotEmpty() && password.isNotEmpty()) {
                ...
                val intent = Intent(this, Ingreso2::class.java)
